...
# Rangos de Colores
#Rojo
rojo_bajo1 = np.array([0,100,255], np.uint8)
rojo_alto1 = np.array([7,100,255], np.uint8)

rojo_bajo2 = np.array([175,100,255], np.uint8)
rojo_alto2 = np.array([179,100,255], np.uint8)
...
while True:
    ...
    if hayvideo == True:
        videoHSV = cv.cvtColor(video_redimensionado, cv.COLOR_BGR2HSV)
